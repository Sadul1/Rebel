                ...
                <body>
                                ...
                                <div class="row row-jc">
                                    ...
                                    <!-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 tr-d">
                                        <div class="section-page-info-breadcrumbs">
                                            ...
                                            <a href="#" class="current">Contacts</a>
                                        </div>
                                    </div> -->
                                </div>
                            </div>
                                        ...
                                        <ul class="section-contacts-nav">
                                            ...
                                            <li class="section-contacts-item">
                                                ...
                                                <div class="section-contacts-info">
                                                    ...
                                                    <a href="#" class="section-contacts-link">No.29 , Old Quarry Road, Mount Lavinia</a>
                                                    <a href="#" class="section-contacts-link">Sri Lanka.</a>
                                                </div>
                                            </li>
                                            <li class="section-contacts-item">
                                                ...
                                                <div class="section-contacts-info">
                                                    ...
                                                    <a href="#" class="section-contacts-link">hello@rebel.lk</a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 tr mb-center">
                                        <a href="#" class="section-proposition-btn btn btn-b btn-lg">REQUEST A CALLBACK</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    google.maps.event.addDomListener(window, 'load', init);
                        ...
                        var beachMarker = new google.maps.Marker({
                            position: { lat: 40.718994, lng: -74.030574 },
                            map: map,
                            icon: image
                        });
                    }
